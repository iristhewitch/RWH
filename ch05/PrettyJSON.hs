...
-- pointy: string s = enclose '"' '"' (hcat (map oneChar s))

-- wraps a Doc value with opening and closing characters
enclose :: Char -> Char -> Doc -> Doc
enclose left right x = char left <> x <> char right

-- renders individual characters
oneChar :: Char -> Doc
...
-- an "association list"; associates character with escaped representation
